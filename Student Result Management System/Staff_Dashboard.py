...
class RMS:
    def __init__(self,root):
        ...
        #-----Title-------
        title = Label(self.root, text="Student Result Management System (Staff Dashboard)",padx=10,compound=LEFT,image=self.logo_dash,font=("goudy old style",20,"bold"),bg="#033054", fg="white").place(x=0, y=0, relwidth=1, height=50)
        #-----Menu--------
