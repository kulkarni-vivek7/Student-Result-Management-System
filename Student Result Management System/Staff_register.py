...
class Register_staff:
    def __init__(self,root):
        ...
        title = Label(frame1,text="Staff Registration",font=("times new roman",20,"bold"),bg="white",fg="green").place(x=50,y=30)
        ...
        if self.txt_fname.get() == "" or self.txt_contact.get() == "" or self.txt_email.get() == "" or self.cmb_quest.get() == "" or self.txt_answer.get() == "" or self.txt_password.get() == "" or self.txt_cpassword.get() == "":
            ...
            try:
                ...
                if row != None:
                    ...
                    cur.execute("insert into staff(f_name,l_name,contact,email,question,answer,password) values(?,?,?,?,?,?,?)",
                                    (self.txt_fname.get(),
                                    self.txt_lname.get(),
