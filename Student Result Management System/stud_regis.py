...
class Register_stud:
    def __init__(self,root):
        ...
        title = Label(frame1,text="Student Registration",font=("times new roman",20,"bold"),bg="white",fg="green").place(x=50,y=30)
    ...
    def login_window(self):
        self.root.destroy()
        os.system("python Login_stud.py") 
        ...
        if self.txt_fname.get() == "" or self.txt_contact.get() == "" or self.txt_email.get() == "" or self.cmb_quest.get() == "" or self.txt_answer.get() == "" or self.txt_password.get() == "" or self.txt_cpassword.get() == "":
            ...
            try:
                ...
                if row != None:
                    ...
                    cur.execute("insert into student_regis(f_name,l_name,contact,email,question,answer,password) values(?,?,?,?,?,?,?)",
                                    (self.txt_fname.get(),
                                    self.txt_lname.get(),
